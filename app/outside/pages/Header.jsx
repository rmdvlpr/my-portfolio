...
const Header = () => {
  return (
    <div className="min-h-screen p-4 sm:p-8 flex flex-col gap-6 sm:gap-10">
      {/* Top Section */}
      <div className="border-2 border-black rounded-3xl flex flex-col items-start p-6 sm:p-10 lg:flex-row lg:items-center lg:gap-20 lg:px-20">
      ...
      {/* Bottom Section */}
      <div className="flex flex-col gap-6 sm:gap-10 lg:flex-row lg:justify-center">
        {/* Left Column */}
