...
const bg =
  "https://ik.imagekit.io/ramparedes/Images/BG_HERO.jpeg?updatedAt=1758704549826";
...
const HeroOutside = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl select-none w-full mx-auto bg-black rounded-2xl shadow-2xl flex flex-col lg:flex-row overflow-hidden my-weekends-hero-content mt-30 md:mt-24">
        ...
        <div className=" montserrat w-full lg:w-2/5 flex-shrink-0 bg-gradient-to-br from-zinc-100 to-zinc-300 text-black p-8 sm:p-12 flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 my-weekends-hero-text">
            A Glimpse
            <br />
            Beyond
            <br />
          ...
          <p className="text-zinc-700 text-base md:text-lg leading-relaxed max-w-md my-weekends-hero-text">
          ...
          <div className="h-full flex flex-col md:flex-row gap-4 montserrat">
            ...
            <div className="w-full md:w-1/3 flex flex-col nature-card">
              <div className="flex-grow relative rounded-xl overflow-hidden">
                <Image
                  src="https://ik.imagekit.io/ramparedes/Images/me3.png?updatedAt=1758617842772"
                  alt="me"
                  layout="fill"
                  objectFit="cover"
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-4">
              ...
              <div className="flex-grow relative rounded-xl overflow-hidden peace-card">
                <Image
                  src="https://ik.imagekit.io/ramparedes/Images/cagua.png?updatedAt=1758617829073"
                  alt="Cagua Volcano"
                  layout="fill"
                  objectFit="cover"
                  className="absolute inset-0"
